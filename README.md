...
| **Size** | Size of the readout — 25% / 50% / 75% / 100% / 125% / 150% (100% by default, the standard DPI-scaled size). Handy to shrink the readout on high-scaling displays where it fills the taskbar; enlargement is capped by the taskbar height, so it never clips. Previews live |
